...
class ChildLifecycleEvent(models.Model):
    ...
    child_id = fields.Many2one(
        "compassion.child", "Child", required=True, ondelete="cascade", readonly=True
    )
    ...
    request_reason = fields.Selection(
        [
            ...
            ("relocation: change of caregiver", "of a change of caregiver"),
            ("relocation: moved to another area", "{he} moved to another area"),
            (
            ...
            (
                ...
                "comments box below)",
                "{he} is the in system under two numbers",
            ),
            (
            ...
            ("no longer needs our assistance", "{he} no longer needs our assistance"),
            ("project capacity issue", "of project capacity issue"),
            ("registered / transferred incorrectly", "{he} registered incorrectly"),
            (
